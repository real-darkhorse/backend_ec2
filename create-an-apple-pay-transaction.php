...
function createAnApplePayTransaction($amount){
    ...
    $transactionRequestType->setAmount($amount);//151
    ...
    if ($response != null)
    {
        ...
        else
        {
			...
			$result['res'] = 'error';
			$result['code'] = 1;
			$result['error'] = "ERROR :  Invalid response";
			$result['error_details'] = "Response : " . $errorMessages[0]->getCode() . "  " .$errorMessages[0]->getText() . "\n";
			return $result;
        }
    }
    else
